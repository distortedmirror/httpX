...
docker create -t -p 127.0.0.1:5901:5901/tcp -p 127.0.0.1:8080:8080/tcp -p 127.0.0.1:6080:6080/tcp -p 127.0.0.1:2222:22/tcp --privileged   gcr.io/venus_paula_williams:v1 /usr/bin/systemd --system > containerid.txt 
