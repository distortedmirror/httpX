...
echo 'If fails try ./killall.sh;./novncdockerkali.sh on cloud and ./killall.sh;./novnc.sh on container'
echo Finally run in container: passwd\; passwd mark\; vncpasswd
